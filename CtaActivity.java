...
class calculator extends JFrame implements ActionListener {
	...
	calculator() {
		...
		l8.setText("");
		l10 = new JLabel("   ");
		b2 = new JButton(" Check Eligibility for SEE");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == b2) {
			...
			if (a > 20 || a < 0) {
				JOptionPane.showMessageDialog(this, " invalid IA-1 marks", "error", JOptionPane.ERROR_MESSAGE);
				t1.setText("");
				return;
			}

			if (b > 20 || b < 0) {
				JOptionPane.showMessageDialog(this, " invalid IA-2 marks", "error", JOptionPane.ERROR_MESSAGE);
				t2.setText("");
				return;
			}

			if (c > 20 || c < 0) {
				JOptionPane.showMessageDialog(this, " invalid IA-3 marks", "error", JOptionPane.ERROR_MESSAGE);
				t3.setText("");
				return;
			}
			if (d > 10 || d < 0) {
		...
		if (e.getSource() == b1) {
			...
			if (f > 100 || f < 0) {
				JOptionPane.showMessageDialog(this, "invalid SEE marks", "error", JOptionPane.ERROR_MESSAGE);
				t5.setText("");
				l8.setText("");
				l7.setText("");
				return;
